...
{
    std::cout << this->_name << "'s AForm constructor called" << std::endl;
}
...
{
    std::cout << this->_name << "'s AForm copy constructor called" << std::endl;
}

AForm::~AForm()
{
    std::cout << this->_name << "'s AForm destructor called" << std::endl;
}
